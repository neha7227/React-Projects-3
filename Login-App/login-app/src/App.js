...
e.preventDefault()
if(obj.username === "user" && obj.password==="password") setWelcomeMsg(true)
...
{(invalidMsg)?<p>"Invalid username or password"</p>:""}
  ...
  <label>Password:<input id="password" name="password" type="password" placeholder="password" required onChange={handleInput}></input></label>
